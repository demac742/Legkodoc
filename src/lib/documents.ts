    ...
    ...{
        ...
        "page": {
            ...
            "howToFill": [
                ...
                "Проверьте приложения и скачайте PDF для проверки перед подачей."
            ],
            "afterDownload": [
            ...
            "articleSections": [
                {
                    "title": "Заявление в банк по исполнительному документу",
                    "paragraphs": [
                        "Это заявление используют, когда взыскатель хочет предъявить исполнительный документ прямо в банк должника и получить деньги без ручной подготовки текста.",
                        "В заявлении указывают банк, взыскателя, должника, сумму взыскания, реквизиты для перечисления денег и приложения."
                    ]
                },
                {
                    "title": "Самая частая ситуация",
                    "paragraphs": [
                        "У взыскателя уже есть исполнительный лист о взыскании долга. Должником может быть физическое лицо или организация. Если взыскатель знает, в каком банке у должника открыт счет, он подает заявление и исполнительный документ прямо в банк.",
                        "После этого банк может списать деньги со счета должника в пределах указанной суммы и перечислить их взыскателю по реквизитам из заявления."
                    ]
                },
                {
                    "title": "Что подготовить перед заполнением",
                    "paragraphs": [
                        "Подготовьте исполнительный документ, название и адрес банка, данные взыскателя и должника, а также реквизиты счета для перечисления денег.",
                        "Если в исполнительном документе отдельно не выделены неустойка, госпошлина или иные суммы, эти поля можно оставить пустыми."
                    ]
                },
                {
                    "title": "Что войдет в заявление",
                    "paragraphs": [
                        "В готовый текст попадают реквизиты исполнительного документа, сведения о взыскателе и должнике, сумма взыскания, счет для перечисления денег и список приложений.",
                        "Конструктор подстраивает формулировки под выбранный вид исполнительного документа, чтобы заявление выглядело цельно и без лишних пустых фраз."
                    ]
                },
                {
                    "title": "Что проверить перед подачей",
                    "paragraphs": [
                        "Перед подачей сверьте банк, данные должника, реквизиты исполнительного документа, сумму взыскания и счет для перечисления денег.",
                        "Распечатайте заявление, подпишите его, приложите оригинал исполнительного документа и сохраните подтверждение подачи в банк."
                    ]
                }
            ],
            "faq": [
  ...
  },
  {
    ...{
        ...
        "sampleValues": {
            ...
            "targetName": "Управление МВД России по Кировской области",
            "governmentDisputeSubject": "дело о рассмотрении обращения и представленных документов",
            ...
            "principalOrganizationName": "ООО \"Горпроект\"",
        ...
        "page": {
            "suitableFor": [
                "Для разовых бытовых и административных задач, когда нужно поручить другому человеку подать документы, подписать обращение, получить ответ или представить интересы в организации.",
                "Для обращений в государственный или муниципальный орган, если нужна простая письменная доверенность без нотариального удостоверения.",
                "Для получения почтовых отправлений, представления интересов в организации или обращения в иной орган, который принимает такую форму доверенности."
            ],
            "notSuitableFor": [
                "Для сделок с недвижимостью, регистрационных действий, распоряжения долями и других случаев, где закон требует нотариальную доверенность.",
                "Для полноценного ведения дела в суде по существу спора, если нужны специальные процессуальные полномочия представителя.",
                "Для действий с деньгами, имуществом или иными правами, где конкретный орган или закон требует отдельную форму доверенности."
            ],
            "requiredData": [
                "Данные доверителя: для физлица — ФИО, дата рождения, паспорт и адрес; для ИП — также ОГРНИП и ИНН; для юрлица — реквизиты организации и данные подписанта.",
                "Данные доверенного лица: ФИО, дата рождения, паспортные данные и адрес регистрации.",
                "Куда будет предъявляться доверенность: конкретный орган, организация или отделение почтовой связи, а для почты — еще номер или обозначение отделения и адрес.",
                "Перечень полномочий: что именно доверенное лицо вправе делать от имени доверителя.",
                "Город, дата подписания, срок действия доверенности и дата, до которой она действует."
            ],
            "howToFill": [
                "Выберите тип адресата: государственный орган, почта или другой адресат, затем укажите конкретное место, куда будет предъявляться доверенность.",
                "Заполните данные доверителя и доверенного лица точно по документам, без сокращений и свободных пересказов.",
                "Отметьте только те полномочия, которые действительно нужны для вашей ситуации.",
                "Если стандартных формулировок мало, добавьте иные действия простыми и понятными словами.",
                "Перед скачиванием проверьте срок действия, адресата и список полномочий, а затем сформируйте PDF."
            ],
            "afterDownload": [
                "Подпишите доверенность, при необходимости впишите ФИО доверителя прописью и передайте оригинал доверенному лицу.",
                "Перед обращением уточните у конкретного органа или организации, принимает ли он простую письменную доверенность для выбранного действия."
            ],
            "articleSections": [
                {
                    "title": "Что это за доверенность и как она работает",
                    "paragraphs": [
                        "Эта доверенность нужна, когда один человек или организация хочет письменно поручить другому лицу конкретные действия от своего имени. Для простых бытовых и административных ситуаций часто достаточно обычной письменной формы без нотариуса.",
                        "Главная задача такого документа — ясно показать, кто выдал доверенность, кому именно, куда будет обращаться доверенное лицо и какие действия ему разрешены."
                    ]
                },
                {
                    "title": "Самая частая ситуация",
                    "paragraphs": [
                        "Обычный пример: доверитель не может лично обратиться в государственный орган или организацию, но нужно подать заявление, подписать документы, получить ответ или передать материалы по делу.",
                        "Вместо свободного текста удобнее сразу выбрать готовые полномочия в конструкторе и оставить только те действия, которые реально понадобятся доверенному лицу."
                    ]
                },
                {
                    "title": "Что подготовить перед заполнением",
                    "paragraphs": [
                        "Заранее подготовьте данные доверителя и доверенного лица. Для физлиц и ИП это паспортные сведения и адрес, для юрлица — наименование, ОГРН, ИНН, данные подписанта и основание его полномочий.",
                        "Также заранее определите адресата и перечень полномочий. Чем точнее формулировки и уже список действий, тем проще использовать доверенность на практике."
                    ]
                },
                {
                    "title": "Дата, срок и адресат",
                    "paragraphs": [
                        "В доверенности важно указать дату подписания и срок действия. Удобнее всего либо задать срок на конкретный период, либо указать дату, до которой документ действует.",
                        "Адресата тоже лучше конкретизировать: не просто \"госорган\", а конкретный орган, подразделение, организация или отделение почты, где документ будут предъявлять."
                    ]
                },
                {
                    "title": "Когда подходит, а когда нужен другой формат",
                    "paragraphs": [
                        "Шаблон подходит для простых поручений: подать документы, получить ответ, представить интересы в организации, ознакомиться с материалами, получить корреспонденцию или выполнить похожее действие без распоряжения имуществом.",
                        "Если речь идет о сделке, регистрации прав, распоряжении имуществом, получении присужденных денег или полном судебном представительстве, обычно нужен другой формат доверенности или нотариальное удостоверение."
                    ]
                },
                {
                    "title": "Что важно помнить для суда",
                    "paragraphs": [
                        "Если доверенность нужна для суда, в рамках этого шаблона лучше ограничиваться безопасными действиями: подачей документов, ознакомлением с материалами, получением копий и иными вспомогательными полномочиями.",
                        "Для полноценного ведения дела, подписания процессуальных документов в широком объеме или совершения специальных процессуальных действий могут понадобиться отдельные полномочия и другой формат доверенности."
                    ]
                }
            ],
            "faq": [
